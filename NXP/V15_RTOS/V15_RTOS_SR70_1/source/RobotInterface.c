...
void MotorRun(RobotInterface * m, int i)
{
	int dir = m->m_movPar.dir[i];
	int Sigs = m->m_movPar.vel[i];
	...
	switch(i){
		case 0:
									...
									if ( dir == 1 ) // CW
									{
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR1, BOARD_FTM_CHANNEL1, kFTM_CenterAlignedPwm, (Sigs));
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR1, BOARD_FTM_CHANNEL1b, kFTM_CenterAlignedPwm, 0U);
									}
									if ( dir == -1 ) // CCW
									{
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR1, BOARD_FTM_CHANNEL1, kFTM_CenterAlignedPwm, 0U);
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR1, BOARD_FTM_CHANNEL1b, kFTM_CenterAlignedPwm, (Sigs));
									}
									if ( dir == 0 ) // BREAK
									{
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR1, BOARD_FTM_CHANNEL1, kFTM_CenterAlignedPwm, 0U);
		...
		case 1:
									...
									if ( dir==1 ) // CW
									{
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR2, BOARD_FTM_CHANNEL2, kFTM_CenterAlignedPwm, (Sigs));
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR2, BOARD_FTM_CHANNEL2b, kFTM_CenterAlignedPwm, 0U);
									}
									if ( dir ==-1 ) // CCW
									{
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR2, BOARD_FTM_CHANNEL2, kFTM_CenterAlignedPwm, 0U);
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR2, BOARD_FTM_CHANNEL2b, kFTM_CenterAlignedPwm, (Sigs));
									}
									if ( dir ==0 ) // BREAK
									{
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR2, BOARD_FTM_CHANNEL2, kFTM_CenterAlignedPwm, 0U);
		...
		case 2:
									...
									if ( dir == 1) // CW
									{
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR3, BOARD_FTM_CHANNEL3, kFTM_CenterAlignedPwm, (Sigs));
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR3, BOARD_FTM_CHANNEL3b, kFTM_CenterAlignedPwm, 0U);
									}
									if ( dir == -1 ) // CCW
									{
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR3, BOARD_FTM_CHANNEL3, kFTM_CenterAlignedPwm, 0U);
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR3, BOARD_FTM_CHANNEL3b, kFTM_CenterAlignedPwm, (Sigs));
									}
									if ( dir == 0 ) // BREAK
									{
									FTM_UpdatePwmDutycycle(BOARD_FTM_BASEADDR3, BOARD_FTM_CHANNEL3, kFTM_CenterAlignedPwm, 0U);
